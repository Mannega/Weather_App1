...
function switchTheme() {
	if (preferedTheme === 'dark') {
		...
		// Modal styles
		popupDiv.style.backgroundColor = '#212121';
		document.getElementById('popupHeading').style.color = 'white';
		document.getElementById('popupText').style.color = 'rgba(255, 255, 255, 0.9';
	} else {
